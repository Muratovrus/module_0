...
def game_core_v3(number):
    '''Сначала устанавливаем любое random число, а потом уменьшаем или увеличиваем его на числа от 1 до 90 в зависимости от того,
    больше оно или меньше нужного. Числа от 1 до 90 позволяют попасть программе в "нужный десяток".
